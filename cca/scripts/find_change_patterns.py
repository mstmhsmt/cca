...
from factutils.fact import Fact
from factutils.rdf import Resource, Predicate, Literal
import factutils.range
...
ENUM_QUERY_DIR = os.path.join(pathsetup.CCA_HOME, 'queries', 'enum')
...
class Finder(object):
    ...
    def get_extra_ent_pairs(self, chgpat, bent0, bent1):
        ...
        res.sort(key=lambda x: factutils.range.Key(x[2].get_range()))
